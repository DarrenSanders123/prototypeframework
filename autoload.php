 ...
 * @generated by AutoLoadOne 1.26 generated 2022/05/11 11:59:42
...
$s627ba52e3f167__arrautoloadCustom = [

];
$s627ba52e3f167__arrautoloadCustomCommon = [

];

/* @var string[] Where $_arrautoload['namespace']='folder' */
$s627ba52e3f167__arrautoload = [
	'DS' => '/../router'
];
$s627ba52e3f167__arrautoloadCommon = [

];

/* @var boolean[] Where $_arrautoload['namespace' or 'namespace\Class']=true if it's absolute (it uses the full path) */
$s627ba52e3f167__arrautoloadAbsolute = [
 ...
 * @throws Exception
 */
function s627ba52e3f167__auto($class_name)
{
    ...
    // special cases
    if (isset($GLOBALS['s627ba52e3f167__arrautoloadCustom'][$class_name])) {
        s627ba52e3f167__loadIfExists($class_name,$GLOBALS['s627ba52e3f167__arrautoloadCustom'][$class_name]
            , $class_name,'s627ba52e3f167__arrautoloadCustomCommon');
        restore_exception_handler();
        return;
    }
    // normal (folder) cases
    if (isset($GLOBALS['s627ba52e3f167__arrautoload'][$ns])) {
        s627ba52e3f167__loadIfExists($class_name,$GLOBALS['s627ba52e3f167__arrautoload'][$ns] . '/' . $cls . '.php'
            , $ns,'s627ba52e3f167__arrautoloadCommon');
        restore_exception_handler();
        return;
    }
 ...
 * @throws Exception
 */
function s627ba52e3f167__loadIfExists($className,$filename, $key,$arrayName='')
{
    if (isset($GLOBALS['s627ba52e3f167__arrautoloadAbsolute'][$key])) {
        ...
        $fullFile = __DIR__ . '/' . s627ba52e3f167__replaceCurlyVariable($filename, $arrayName); // its relative to this path
    }
...
function s627ba52e3f167__replaceCurlyVariable($string,$arrayName) {
...
spl_autoload_register(static function ($class_name) {
    s627ba52e3f167__auto($class_name);
});
